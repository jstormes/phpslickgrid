 ...
 *
 */
class PHPSlickgrid_View_Helper_ModelOnly extends Zend_View_Helper_Abstract
{
	/**
	 * Table
	 ...
	 * @return string
	 */
	public function ModelOnly(PHPSlickGrid_Db_Table $Table) {
